...
public class HowToPlayDialogFragment extends DialogFragment {
    @BindView(R.id.how_to_play_ctv_tv_id)
    TextView textView;

    public static HowToPlayDialogFragment newInstance() {
        return new HowToPlayDialogFragment();
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_dialog_how_to_play, container);
...
//        layout.setBackgroundColor(Color.TRANSPARENT);
    ...
    public void closeFragment() {
        getActivity().getSupportFragmentManager().beginTransaction().remove(HowToPlayDialogFragment.this).commit();
    }
